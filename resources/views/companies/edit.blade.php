    ...
    <div class="col-10 col-sm-8">
        <div class="card card-pages m-t-40 shadow-none bg-transparent">
            ...
            <form method="POST" action="/companies/{{ $companies->id }}">
                ...
                <div class="field">
                    <div class="control">
                        <button type="submit" class="btn btn-danger btn-block  waves-effect waves-light" >Kaydet</button>
                    </div>
                </div>
            </form><br>
                <a data-toggle="modal" data-target=".status-modal" class="level-item" style="font-size: 18px;">
                    <div class="control">
                        <button type="submit" class="btn btn-danger btn-block  waves-effect waves-light" >Sil</button>
                    </div>
                </a>
            {{-- status-modal --}}
            <div class="col-1 col-sm-2"></div>
